...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
        ...
        if (requestCode == OPEN_DOCUMENT_TREE && resultCode == Activity.RESULT_OK && resultData != null) {
            if (resultData.data != null && isProperSDFolder(resultData.data!!)) {
            ...
            if (resultData.data != null && isProperOTGFolder(resultData.data!!)) {
    ...
    private fun saveTreeUri(resultData: Intent) {
        ...
        if (treeUri != null) {
            ...
            Log.e(BaseSimpleActivity::javaClass.name + "", "treeUri is null")
        }
    }

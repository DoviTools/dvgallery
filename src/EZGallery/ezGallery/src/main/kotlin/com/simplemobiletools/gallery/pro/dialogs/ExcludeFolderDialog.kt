...
class ExcludeFolderDialog(val activity: BaseSimpleActivity, val selectedPaths: List<String>, val callback: () -> Unit) {
    ...
    init {
        ...
        val textView = view.findViewById<TextView>(R.id.exclude_folder_description)
        textView.text = activity.getString(R.string.exclude_folder_description, activity.getString(R.string.app_name))
